...
- Added `search_source_file_chunks/3` in [`lib/lemmings_os/knowledge.ex`](/mnt/data4/matt/code/personal_stuffs/lemmings-os/lib/lemmings_os/knowledge.ex) for pgvector similarity retrieval.
...
## Query/Type Wiring
- Reused existing migration [`priv/repo/migrations/20260506120000_add_knowledge_source_files_and_chunks.exs`](/mnt/data4/matt/code/personal_stuffs/lemmings-os/priv/repo/migrations/20260506120000_add_knowledge_source_files_and_chunks.exs) and its HNSW index; no new migration created.
- Added pgvector repo type wiring:
  - [`lib/lemmings_os/postgres_types.ex`](/mnt/data4/matt/code/personal_stuffs/lemmings-os/lib/lemmings_os/postgres_types.ex)
  - repo `types` config in `config/dev.exs`, `config/test.exs`, and `config/runtime.exs`
- Added `embedding` field to [`lib/lemmings_os/knowledge/source_file_chunk.ex`](/mnt/data4/matt/code/personal_stuffs/lemmings-os/lib/lemmings_os/knowledge/source_file_chunk.ex).

## Validation
- Added/updated retrieval tests in [`test/lemmings_os/knowledge/source_files_context_test.exs`](/mnt/data4/matt/code/personal_stuffs/lemmings-os/test/lemmings_os/knowledge/source_files_context_test.exs):
